# Generated by Django 6.0.3 on 2026-04-05 09:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rental_rate', models.DecimalField(blank=True, decimal_places=2, max_digits=4, null=True)),
                ('length', models.IntegerField(blank=True, null=True)),
                ('replacement_cost', models.DecimalField(blank=True, decimal_places=2, max_digits=5, null=True)),
            ],
            options={
                'db_table': 'film',
                'managed': False,
